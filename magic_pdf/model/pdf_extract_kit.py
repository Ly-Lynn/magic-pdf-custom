    ...
    def __call__(self, image):
        ...
        if self.apply_ocr:
            ...
            for res in ocr_res_list:
                ...
                cropped_img_path = os.path.join(r'D:\codePJ\Mely\MeLy-MinerU\demo\demovie5\ocr_bboxes', cropped_img_name)
                new_image.save(cropped_img_path)
                index+=1
            ...
            logger.info(f"ocr nek: {ocr_cost}")
