...
class Layoutlmv3_Predictor(object):
    ...
    def __call__(self, image, ignore_catids=[]):
        ...
        for bbox_idx in range(len(boxes)):
            ...
            cropped_img = pilimage.crop(box)  

            category_name = self.mapping[labels[bbox_idx]]
            cropped_img_name = f"bbox_{bbox_idx}_{category_name}.jpg"
            cropped_img_path = os.path.join(r'D:\codePJ\Mely\MeLy-MinerU\demo\demovie3\bboxes', cropped_img_name)
